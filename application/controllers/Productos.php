...
class Productos extends CI_Controller {
	...
	public function listarProductos(){
     ...
     //pagination settings
        ...
        $this->load->view('template/tp_header_view',$data);                      
        $this->load->view('catalogo/productos_view', $data);  
        $this->load->view('template/tp_footer_view'); 
	...
	public function listarDetalleProducto(){
		...
		if ($this->uri->segment(3))
		{
            ...
            $this->load->view('template/tp_header_view',$data);                      
            $this->load->view('catalogo/detalle_producto_view',$data);
            $this->load->view('template/tp_footer_view');     
            ...
            $data['similares'] = $similares;
            $this->load->view('template/tp_header_view',$data);                      
            $this->load->view('catalogo/detalle_producto_not_found_view',$data);
            $this->load->view('template/tp_footer_view');     
    ...
    function llenar_productos_by_categorias_sucursal(){
        ...
        if(($this->input->post('id_sucursal'))||($this->input->post('id_sucursal')==0))
        {
            $id_categoria=$this->input->post('id_categoria'); 
    ...
    function obtener_info_producto(){
        ...
        if($this->input->get('id_producto')){
            ...
            $aux = $this->productos_model->get_detalle_producto_by_id($id_producto);
            $id_sucursal=$this->session->userdata('id_sucursal');
            $precios = $this->productos_model->get_precio_producto_by_sucursal($id_producto,$id_sucursal);
             if(count($aux)>0){
                //$response=$aux[0];
