...
<div class="panel panel-default">
  ...
  <div class="row">
    ...
    <div class="col-sm-4">Ci/Nit: <?php echo $cliente['ci'];
  ...
  <div class="row">
      <div class="col-sm-offset-3 col-sm-4 text-center">
       <?php
         if(isset($ventas_suspendidas)){
       ?>
      <a href="ventas_suspendidas" class="btn btn-info" role="button">Volver a Ventas</a><?php 
           }else{
            ?>
      <a href="ventas_contado" class="btn btn-info" role="button">Volver a Ventas</a>
            <?php
           }
        ?>      
