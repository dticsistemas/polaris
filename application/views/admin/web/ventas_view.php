...
<div class="panel-heading">
    <h2 class="panel-title text-center">Venta de Productos</h2>
</div>
...
<div class="row">
      <div class="col-sm-9">
           ...
           <div class="col-sm-4 form-group">
             ...
             // print_r($combox_categorias);
              echo form_dropdown('select_categoria', $combox_categorias,'0','class="form-control" onchange="cargar_productos(this.value)" id="select_categoria"' );
                   ?>
            </div>
      ...
      <div class="col-sm-3 form-group">          
          <?php $img=base_url().'/assets/img/catalogo/thumbs/no_image.png';?>
          <img name="img-prod-thumb" id="img-prod-thumb" onclick="precios_producto()" class="img-responsive thumbnail"
           src="<?php echo $img; ?>"/>                 
      </div>
</div> <!--End row-->
...
<div class="row">
  ...
  <div class="col-sm-8">
     ...
     <input class="form-control" id="descripcion" placeholder="descripcion" name="descripcion" type="text" value=" Venta de productos al contado" >
...
<div id="myModalEdit" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <input type="hidden" id="precio_hidden" value="0"/>
      <div class="modal-body">
...
function cargar_productos(str) {
 
  //var select_producto=$("#select_producto");
  //select_producto.attr("value")="1";  
  $.post( "<?php echo base_url('productos/llenar_productos_by_categorias');?>", 
    {id_categoria:str},
    function( data ) {
      //---respuesta
    ...
    $.get( "<?php echo base_url('productos/obtener_info_producto');?>", 
      ...
      function( data ) {       
       //---respuesta              
        ...
        var medida=' la '+ res['medida'];
        if (precio<0){
          precio='0';
          medida='';
          alert('No tiene precio definido');
        }
        ...
        document.getElementById('precio').innerHTML=precio+medida;   
        document.getElementById('precio_hidden').value=precio;             
...
function calculo_monto(cantidad){
  var precio=document.getElementById('precio_hidden').value; 
...
var nro_productos=0; 
var id_elementos=0;
function agregar(valor,valor_id) {
